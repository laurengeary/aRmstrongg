...
## Introduction
In this study, we will study the force length relationship of the human upper limb and its response to fatigue. To determine the relationship, measurements will be taken before the upper limb muscles are not fatigued and then after they are fatigued. More specifically, we will see the effects of eccentric fatigue, where a muscle is under stress/tension while lengthening. Research on the changes in the quadriceps muscle following eccentric fatigue shows that “there was a significant shift in the peak torque angle to longer muscle lengths in the eccentrically-exercised leg immediately and on the following two days after exercise when compared with baseline” [@yeung2007shift]. We will apply this concept to determine if eccentric fatigue shifts the force length relationship of human forearm flexors. We will then analyze class-wide force-angle data for isometric MVC and see if it follows a typical force length relationship both under control and fatigue conditions. Finally, we will analyze if there is a significant shift between θmax between the control and fatigue FL relationships. 
